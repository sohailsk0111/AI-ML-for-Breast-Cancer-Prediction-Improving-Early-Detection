#!/usr/bin/env python3
"""
Simplified Testing and Performance Evaluation for Breast Cancer Prediction System
Author: Manus AI
Date: September 2025
"""
...
class SimplifiedModelTester:
    """
    Simplified testing and evaluation system for breast cancer prediction models.
    """
    ...
    def generate_test_report(self, robustness_results, metrics):
        ...
        print("\n1. MODEL ROBUSTNESS:")
        print(f"   - Split Test Stability: {np.mean(robustness_results['split_accuracies']):.4f} ± {np.std(robustness_results['split_accuracies']):.4f}")
        print(f"   - Cross-Validation Stability: {robustness_results['cv_scores'].mean():.4f} ± {robustness_results['cv_scores'].std():.4f}")
...
if __name__ == "__main__":
    ...
    tester.generate_test_report(robustness_results, metrics)
